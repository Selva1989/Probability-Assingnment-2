...
# represented?
#
# Answer: Graph's nodes represents the source and destination of the specific buildings in the campus
#         Graph's edges represents the path between the source and destination nodes.
#         The distances are represented along the edges of the nodes.
...
#print load_map("load_test_map.txt")
#print (load_map(data))
...
#
# Answer: The objective function is to find the shortest path between two nodes.
# The constraints are the total distance travelled on a path is equal to the sum of all total distance travelled 
# between adjacent nodes on the path and minimize the distance travelled while not exceeding the maximum distance outdoors.
...
class Ps2Test(unittest.TestCase):
    ...
    def setUp(self):
        self.graph = load_map("/Users/selva/Documents/SE-30_PS/Prob_set_2/Test_1/mit_map.txt")
